...
export default function EditProduct({ navigation }) {
  ...
  return (
    <View>
      ...
      <ScrollView>
        <View style={{
          height: orientations != 'landscape' ? UseOrientation.height * 2.55 : UseOrientation.height * 3, backgroundColor:
            "#fff",
        }}>

          <View style={{
            flex: 0.03, margin: 10, justifyContent: 'space-between',
            marginBottom: 5,
          }}>
          ...
          <View style={{
            flex: 0.03, margin: 10, backgroundColor:"#fff",}}>
          ...
          <View style={{
            flex: 0.03, margin: 10, justifyContent: 'space-between', backgroundColor: "#fff", }}>
          ...
          <View style={{ flex: 0.03, margin: 10, backgroundColor: "#fff",}}>
            <StatusBar
              hidden
              backgroundColor="#FFF" />
            <View style={styles.viewContainer}>
