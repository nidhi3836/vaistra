        ...
        <View style={{
          ...
          <View style={{ backgroundColor: '#fff', padding: 15, marginTop: 5, }}>
            ...
            <View style={{ flexDirection: 'row', padding: 5 }}>
              <View style={{
                height: 30, width: 30, borderColor: "#b5b5b5", borderWidth: 1,
          ...
          <View style={{ marginTop: 5, backgroundColor: '#fff', padding: 15 }}>
            ...
            <View style={{
              borderWidth: 1, borderRadius: 8, borderColor: "#d5d5d5",
              padding: 20
            }}>
          ...
          <View style={{
            marginTop: 5, backgroundColor: '#fff', padding: 15, flexDirection: 'row',
